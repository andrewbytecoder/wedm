    ...
    en: {
        ...
        cluster: {
            ...
            dashboard: {
                ...
                charts: {
                    ...
                    virtualMemoryTitle: 'Virtual memory',
                    ...
                    dbSizeTitle: 'DB size',
                    revTitle: 'Revision',
                    grpcTitle: 'gRPC request rate',
                    netTitle: 'Network traffic',
                    commitTitle: 'DB commit latency',
                    compactionTitle: 'Compaction keys rate',
                },
                events: {
        ...
        keyEditor: {
            ...
            messages: {
                ...
                revisionsLive:
                    'Revisions below stream from an etcd watch starting at revision 1 (same idea as the legacy app). If the log was compacted, the stream may end with an error.',
                revisionsClickRow:
                    'Click a row to copy that revision value into the value field, then save if you want.',
            },
            columns: {
                key: 'Previous value',
                version: 'Version',
        ...
        saveAsDialog: {
            ...
            messages: {
                empty: 'Please enter a profile name.',
