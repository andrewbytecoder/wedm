    ...
    hu: {
        ...
        keyEditor: {
            ...
            messages: {
                ...
                noWatchRevisions:
                    'Az élő revízió-előzmények (etcd watch) még nincsenek bekötve a Wails asztali változatban.',
                revisionsLive:
                    'A lenti revíziók etcd watch streamből jönnek (1-es revíziótól, a régi alkalmazáshoz hasonlóan). Ha a naplót tömörítették, a stream hibával leállhat.',
                revisionsClickRow:
                    'Kattintson egy sorra, hogy annak értéke bekerüljön az érték mezőbe, majd mentés szükség esetén.',
            },
            columns: {
                key: 'Előző érték',
                version: 'Verzió',
        ...
        saveAsDialog: {
            ...
            messages: {
                empty: 'Adjon meg egy profilnevet.',
                duplicate: 'Ilyen nevű profil már létezik.',
            },
        },
        noSelectionDialog: {
            title: 'Figyelem!',
